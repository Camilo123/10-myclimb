...
import domain.businessService.gps.WebService;
...
public class WeatherActivity extends ActivityOfAF4Ad {
	...
	private void showWeather(String city)
	{
		...
		SoapObject detail = WebService.getWeatherByCity(city);
		//获取天气实况
		...
		weatherToday = "风力:" + detail.getProperty(9).toString();
		...
		weatherTomorrow ="风力:" + detail.getProperty(14).toString();
